  ...
  return (
    <div className="cardT row">
      <TaskPopup
        ...
        task={{ title, details, dueDate, taskID, statusi }}
      />

      <div className="main-text column">
        <p className="cardT-idd">ID: {taskID}</p>
        <p className="cardT-id">{CaseId}</p>
        <div className="row">
          <h1 id={title} className="cardT-title">
            {title}
          </h1>

          {statusi ? (
            <h1 className="cardT-status done">Done</h1>
          ) : (
