...
namespace Detecto.API.Migrations
{
    ...
    [Migration("20230212143141_dyshimi-layer")]
    partial class dyshimilayer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Detecto.API.Suspicion.Models.Detektivi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Detektivet");
                });

            modelBuilder.Entity("Detecto.API.Suspicion.Models.Dyshimi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DateEqeshtjes")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Detecto.API.Data.Models.Personi", b =>
                {
                    b.HasOne("Detecto.API.Suspicion.Models.Dyshimi", null)
                        .WithMany("personat")
                        .HasForeignKey("DyshimiId");
                });
